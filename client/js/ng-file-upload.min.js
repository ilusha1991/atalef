...
ngFileUpload.version = "12.0.4", ngFileUpload.service("UploadBase", ["$http", "$q", "$timeout", function (a, b, c) {
    ...
    this.isUploadInProgress = function () {
        ...
        function h(b, d, e) {
            if (void 0 !== d)if (angular.isDate(d) && (d = d.toISOString()), angular.isString(d))b.append(e, d); else if (f.isFile(d)) {
                ...
                if (d.$$ngfCircularDetection)throw"ngFileUpload: Circular reference in config.data. Make sure specified data for Upload.photos() has no circular reference: " + e;
    ...
    function f(a, b, c, d, f, h, i, j) {
        ...
        function o() {
            ...
            n(a);
            var c = angular.element("<label>photos</label>");
